...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <form action="${pageContext.request.contextPath}/buscar-funcionario?idfuncionario=" 
                  method="post">
                <div class="container">
                        ...
                        <tbody>
                            <c:forEach items="${lista}" var="p">
                                <tr>
                                    ...
                                    <th> <a href='http://localhost:8080/agendaweb-1.0-SNAPSHOT/buscar-funcionario?idfuncionario=${p.id}'> <c:out value="${p.nome}" /> </a></th>
                                    <td><c:out value="${p.sobrenome}" /></td>
                                    <td><c:out value="${p.cpf}" /></td>
                                    <td><c:out value="${p.cargo}" /></td>
                                    <td><c:out value="${p.nivel}" /></td>
                                </tr>
                            </c:forEach>
                        </tbody>    
                    </table>
