...
@WebServlet(name = "BuscarNomeServlet", urlPatterns = {"/buscar-nome"})
public class BuscarNomeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String nomeCarro = request.getParameter("ds_carro");
       // String idcarro = request.getParameter("idcarro");
       String nome = nomeCarro.substring(1, 2);
       // int id = Integer.parseInt(idcarro.substring(1, 2));
        ...
        try {
            ...
            carro = con.selectNome(nomeCarro);

        } catch (Exception e) {

        }

        request.setAttribute("carroAtualizado", carro);
